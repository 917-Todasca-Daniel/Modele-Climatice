...
from utils.dataset import get_house_split_dataset
from models.nn import get_nn_model

import sys
sys.path.append('/home/lavrric/wsl_cs/Modele-Climatice')
...
def train_model():
    ...
    X_train, X_test, y_train, y_test = get_house_split_dataset(good_houses[3], True)

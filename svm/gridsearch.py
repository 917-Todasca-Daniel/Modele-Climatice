...
def grid_search():
    ...
    return GridSearchCV(pipe, params, n_jobs=-1, refit=True, verbose=verbose, scoring='neg_mean_absolute_error')

# cross-validation with 2021
